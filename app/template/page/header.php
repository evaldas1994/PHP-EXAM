            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php else: ?>
                        ...
                        <li><a href="<?php echo BASE_URL ?>/user/index">Players</a></li>
                        <li class="position-relative"><a href="<?php echo BASE_URL ?>/chat/index">Chat<span class="chat-span <?php if ($unseenMessages < 1) { echo 'hidden';} ?>"><?php echo $unseenMessages; ?></span></a></li>
